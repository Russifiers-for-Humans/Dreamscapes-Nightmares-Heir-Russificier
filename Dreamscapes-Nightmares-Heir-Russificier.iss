...
; Всегда меняются
#define GameName "Dreamscapes Nightmares Heir - Premium Edition"                                          ; Название игры
#define GameNameDash "Dreamscapes-Nightmares-Heir"                                          ; Название игры
#define GameNameEXE "Dreamscapes_Nightmares_Heir"                                                              ; Название exe файла игры
#define GameVer "1"                                                                     ; Версия игры
#define GameAppIdSteam "353110"                                                             ; Ид игры в стиме
#define Path "Dreamscapes_Nightmares_Heir_Data"                                                             ; Ид игры в стиме
; От ситуации зависит
...
[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Dreamscapes: Nightmare's Heir - Premium Edition Russificier
AppId={{C6EF706F-4485-4542-9129-6D980F3373CF}
...
[Files]
; Ресурсы
Source: {#Location}\{#GameNameDash}\ini\*; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
